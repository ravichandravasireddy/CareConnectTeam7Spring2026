      ...
      <main role="main" className="login-page">
        <div className="login-card">
          ...
          <form className="login-form" aria-label="Sign in form" onSubmit={(e) => e.preventDefault()}>
            ...
            <input id="email" type="email" className="login-input" placeholder="you@example.com" autoComplete="email" aria-required="true" required />
            <label htmlFor="password" className="login-label">Password</label>
            <input id="password" type="password" className="login-input" placeholder="••••••••" autoComplete="current-password" aria-required="true" required />
