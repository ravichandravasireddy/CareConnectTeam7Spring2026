...
void main() {
  ...
  group('HealthTimelineScreen Rendering', () {
    ...
    testWidgets('should render timeline events when data exists', (
      tester,
    ) async {
      await tester.pumpWidget(createTestHarness());
  ...
  group('HealthTimelineScreen Empty State', () {
    testWidgets('should display empty message when no events exist', (
      tester,
    ) async {
  ...
  group('HealthTimelineScreen Timeline Items', () {
    ...
    testWidgets('should NOT render status labels when not present', (
      tester,
    ) async {
      final healthLogProvider = createEmptyHealthLogProvider();
      healthLogProvider.addLog(
      ...
      await tester.pumpWidget(
        MultiProvider(
          ...
          child: MaterialApp(
            ...
            routes: {'/timeline': (context) => const HealthTimelineScreen()},
          ),
        ),
      );
  ...
  group('HealthTimelineScreen Date Formatting', () {
    ...
    testWidgets('should display "Yesterday" for yesterday\'s events', (
      tester,
    ) async {
      final healthLogProvider = createEmptyHealthLogProvider();
